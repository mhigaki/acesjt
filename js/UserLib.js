$(function() {
    ...
    $("body").one("pinegrow-ready", function(e, pinegrow) {
        ...
        comp_comp1.code = '<div class="left-box"> \
    <h2>localização</h2>\
    <address>Av. Paulista, 807 – 18º andar – cj. 1801<br>esquina com a Alameda Joaquim Eugênio de Lima, próximo à estação do metrô Brigadeiro<br><br> <abbr title="Phone">Tel:</abbr> (11) 3055-1977<br><br></address> \
</div>';
